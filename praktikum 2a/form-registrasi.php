      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="nim" name="nim" placeholder="*0110124138" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 digit angka">
          </div>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="nama_lengkap" name="nama_lengkap" placeholder="*Salsabila" type="text" class="form-control" required="required" maxlength="50" minlength="3">
          </div>
        </div>
      </div>
      <div class="form-group row">
